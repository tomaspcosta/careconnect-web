...
class ManageCaregiversFamilyScreen extends StatelessWidget {
  const ManageCaregiversFamilyScreen({super.key});
...
body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Your older adult currently have 2 caregivers. You can add or remove caregivers as needed.',
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final List<Map<String, dynamic>> persons = [
                    {'name': 'Garbriela Pereira', 'age': 23, 'image': 'assets/images/old-adult-image.png'},
                    {'name': 'Manuela Fonseca', 'age': 34, 'image': 'assets/images/default-profile-picture.png'},
                  ];
